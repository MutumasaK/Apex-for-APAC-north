  ...
  return [
    {
      tier: 'diamond',
      legends: [
        { name: 'Axle', pickRate: 27.4, pickRateLabel: '27.4%', image: '/legends/axle.webp', icon: '/legends/axle.webp', rank: 1 },
        { name: 'Conduit', pickRate: 17.8, pickRateLabel: '17.8%', image: '/legends/conduit.webp', icon: '/legends/conduit.webp', rank: 2 },
        { name: 'Valkyrie', pickRate: 10.1, pickRateLabel: '10.1%', image: '/legends/valkyrie.webp', icon: '/legends/valkyrie.webp', rank: 3 },
        { name: 'Mad Maggie', pickRate: 9.7, pickRateLabel: '9.7%', image: '/legends/mad-maggie.webp', icon: '/legends/mad-maggie.webp', rank: 4 },
        { name: 'Octane', pickRate: 5.9, pickRateLabel: '5.9%', image: '/legends/octane.webp', icon: '/legends/octane.webp', rank: 5 },
      ],
      updatedAt: '現在データ確認中',
      message: '現在データ確認中',
    },
    {
      tier: 'masterPredator',
      legends: [
        { name: 'Axle', pickRate: 33.0, pickRateLabel: '33.0%', image: '/legends/axle.webp', icon: '/legends/axle.webp', rank: 1 },
        { name: 'Conduit', pickRate: 16.6, pickRateLabel: '16.6%', image: '/legends/conduit.webp', icon: '/legends/conduit.webp', rank: 2 },
        { name: 'Valkyrie', pickRate: 14.5, pickRateLabel: '14.5%', image: '/legends/valkyrie.webp', icon: '/legends/valkyrie.webp', rank: 3 },
        { name: 'Mad Maggie', pickRate: 6.2, pickRateLabel: '6.2%', image: '/legends/mad-maggie.webp', icon: '/legends/mad-maggie.webp', rank: 4 },
        { name: 'Octane', pickRate: 4.6, pickRateLabel: '4.6%', image: '/legends/octane.webp', icon: '/legends/octane.webp', rank: 5 },
      ],
      updatedAt: '現在データ確認中',
